...
public class GuestController : ControllerBase
{
    ...
    [HttpGet("{guest_id}")]
    public async Task<ActionResult> GetById([FromRoute] int guest_id)
    {
    ...
    [HttpPut("{guest_id}")]
    public async Task<ActionResult> Update([FromRoute] int guest_id, [FromBody] GuestCreateDTO Data)
    {
        var existingGuest = await _guest.GetById(guest_id);
